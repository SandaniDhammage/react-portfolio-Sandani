...
import { FaNodeJs, FaHtml5, FaCss3Alt, FaJava } from 'react-icons/fa';
import { SiMongodb, SiMysql, SiSelenium,SiJavascript } from 'react-icons/si';
  ...
  return <div className="border-b border-neutral-800 pb-24">
    ...
    transition={{duration:1.5}}
     className="flex flex-wrap items-center justify-center gap-4">
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
            <SiSelenium className="text-6xl text-green-300"/>
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
            <FiFigma className="text-6xl text-pink-400"/>
