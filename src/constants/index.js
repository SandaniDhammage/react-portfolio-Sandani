...
export const EXPERIENCES = [
  {
    ...
    description:  "I am an undergraduate at SLIIT, specializing in Information Technology. SLIIT provides an excellent platform to enhance my IT knowledge through a comprehensive curriculum and hands-on learning opportunities. The university offers a wide range of coursework covering various aspects of IT, including programming, software development, networking, database management, and emerging technologies. These experiences have helped me build a strong foundation in the field and develop the skills required to excel in the industry.",
    technologies: ["Javascript", "React.js", "Next.js", "mongoDB"],
  },
  {
    year: "2018 - 2020",
    role: "C.W.W Kannangara Central Collage-Matugama",
    company: "GCE (A/L) Examination",
    description: `In 2020, I completed my GCE Advanced Level examination in the Arts stream with a Z-score of 1.71. My results highlight my strengths across diverse subjects: an 'A' in Logic & Scientific Method, a 'B' in Information & Communication Technology (ICT), and a 'C' in Agricultural Science.`,
...
export const PROJECTS = [
  {
    title: "The E-commerce Website Testing",
    image: project1,
    description:
...
export const CONTACT = {
  ...
  phoneNo: "+94 71 1074018",
  email: "sandanid01@gmail.com",
};